...
export class OnepageHeaderComponent {
  //Field
    header:string="Hi, I am Volkan ÖZTÜRK "
  ...
  socialContent:SocialContent[]=[
    ...
    {id:1,link:"https://www.youtube.com/channel/UCqpembKV0wtaIbev20hlAmQ",text:"youtube",icon:"fa-brands fa-youtube",classSocial:"btn btn-secondary me-2"},
